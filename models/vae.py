...
from models.class_vae.gido_class_vae.models.conv.nets import ConvLayers,DeconvLayers
from models.class_vae.gido_class_vae.models.fc.nets import MLP
from models.class_vae.gido_class_vae.models.fc.layers import fc_layer,fc_layer_split
...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, image_size, image_channels,
        ...
        if depth == 0:
            self.conv_out_units = input_size
        if fc_layers<2:
