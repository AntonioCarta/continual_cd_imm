...
DATASET_CONFIGS = {
    ...
    'core50': {'size': 1, 'channels': 512, 'classes': 10},
    #-> This dataset contains 50 different objects, but divided over 10 categories.
    #   For each category, there are 5 different objects (e.g., 5 different instances of a mug).
}