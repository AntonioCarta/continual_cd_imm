...
def get_data_loader(dataset, batch_size, cuda=False, drop_last=False):#, collate_fn=label_squeezing_collate_fn):
    '''Return <DataLoader>-object for the provided <DataSet>-object [dataset].'''

    # Create and return the <DataLoader>-object
    return DataLoader(
        dataset, batch_size=batch_size, shuffle=True, drop_last=drop_last,# collate_fn=collate_fn,
