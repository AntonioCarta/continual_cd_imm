...
def show_samples(model, num_channels, image_size, normalize=None, denormalize=None, pdf=None, visdom=None, size=32, sample_mode=None, title="Generated samples",
    ...
    image_tensor = sample.view(-1, num_channels, image_size, image_size).cpu()
    # -denormalize images if needed
    if normalize:
        image_tensor = denormalize(image_tensor).clamp(min=0, max=1)
